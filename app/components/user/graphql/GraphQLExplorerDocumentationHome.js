...
class GraphQLExplorerDocumentationHome extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>
          <RootField name="query.node" /> is a special type of "finder" field that allows you to lookup any record using only it's GraphQL <Scalar name="ID" />.
...
export default GraphQLExplorerDocumentationHome;
