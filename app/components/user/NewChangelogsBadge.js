...
class NewChangelogsBadge extends React.Component {
  ...
  render() {
    return (
      <ReactCSSTransitionGroup transitionName="transition-changelog-appear" transitionAppear={true} transitionAppearTimeout={20000}>
        <span key="badge" className={classNames(this.props.className, "inline-block hover-faded")} style={this.props.style}>
          <a href="/changelog" className="bg-lime white hover-white btn line-height-1" style={{ padding: '3px 4px', fontSize: '9px', borderRadius: 5 }}>NEW</a>
